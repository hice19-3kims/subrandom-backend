...
insert into save (member_id, recipe_id) values (2, 8);
insert into save (member_id, recipe_id) values (2, 9);
insert into save (member_id, recipe_id) values (2, 10);
insert into save (member_id, recipe_id) values (2, 11);
insert into save (member_id, recipe_id) values (2, 12);
insert into save (member_id, recipe_id) values (2, 13);
insert into save (member_id, recipe_id) values (2, 14);
insert into save (member_id, recipe_id) values (2, 15);

insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (1, 1, 5.0, "훌륭합니다.", 0, '2024-03-05');
insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (1, 2, 4.0, "훌륭.", 1, '2024-03-06');
insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (1, 3, 3.5, "괜찮다.", 2, '2024-03-07');
insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (1, 4, 2.0, "흠...", 3, '2024-03-08');
insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (1, 5, 5.0, "훌륭합니다.", 4, '2024-03-09');
insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (1, 6, 0.5, "개판.", 5, '2024-03-10');
insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (1, 7, 5.0, "훌륭함.", 6, '2024-03-11');
insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (2, 8, 2.5, "그럭저럭.", 0, '2024-03-12');
insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (2, 9, 0.0, "아...", 1, '2024-03-12');
insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (2, 10, 5.0, "맛있음.", 2, '2024-03-13');
insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (2, 11, 4.5, "좋다.", 3, '2024-03-13');
insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (2, 12, 2.0, "아쉽다.", 4, '2024-03-14');
insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (2, 13, 1.5, "싫어요.", 5, '2024-03-14');
insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (2, 14, 5.0, "환상.", 6, '2024-03-15');
insert into review (member_id, recipe_id, score, comment, heart_counts, date) values (2, 15, 0.5, "상상하기 싫다.", 7, '2024-03-15');